...
const SettingsTabs = createTabbedView({
  tabs: [
    { icon: 'tabler:building', id: 'company', name: 'tabs.company' },
    { icon: 'tabler:settings', id: 'defaults', name: 'tabs.defaults' },
    { icon: 'tabler:building-bank', id: 'bank', name: 'tabs.bank' },
    { icon: 'tabler:123', id: 'numbering', name: 'tabs.numbering' }
  ]
})
...
export default function ModifySettingsModal({
  ...
  return (
    ...
    >
      <SettingsTabs.Root>
        <SettingsTabs.Selector />
        <SettingsTabs.When tabId="company">
          <TextField
            required
        ...
        <SettingsTabs.When tabId="defaults">
          <TextField
            required
            control={form.control}
        ...
        <SettingsTabs.When tabId="numbering">
          <TextField
            required
            control={form.control}
            icon="tabler:hash"
